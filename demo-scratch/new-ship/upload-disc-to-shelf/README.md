...
On eight real photos in local headless Chromium, the ellipse Calculation took 7–11 ms; full Refine took 60–98 ms and Apply took 142–164 ms. IMG_6161 and IMG_6167 produced ellipse repairs; all eight saved outputs were inspected against a checkerboard. These are measured samples, not a device-wide latency guarantee.
