...
// Curated manufacturer suggestions, checked 2026-09-23. Free text stays valid.
export const plasticGuides: Record<string, { source: string; values: string[] }> = {
  ...
  MVP: { source: 'https://mvpdiscsports.com/plastics/', values: ['Neutron', 'Cosmic Neutron', 'R2 Neutron', 'Proton', 'Plasma', 'Eclipse', 'Fission', 'Electron', 'Cosmic Electron'] },
  Axiom: { source: 'https://axiomdiscs.com/plastics/', values: ['Neutron', 'Cosmic Neutron', 'R2 Neutron', 'Proton', 'Plasma', 'Prism', 'Eclipse', 'Total Eclipse', 'Fission', 'Electron', 'Cosmic Electron'] },
  Streamline: { source: 'https://streamlinediscs.com/plastics/', values: ['Cosmic Electron', 'Cosmic Neutron', 'Eclipse', 'Electron', 'Neutron', 'Plasma', 'Proton'] },
