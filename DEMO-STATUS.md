...
## Baseline confirmed live (pre-CircleFit restoration)
...
- CircleFit restoration is pending fresh browser review and publication. Earlier RimFit v3 screenshots are not current CircleFit evidence.
